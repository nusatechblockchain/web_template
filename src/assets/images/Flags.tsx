...
export const IndonesianFlag: React.FC<FLagsProps> = (props: FLagsProps) => {
    return (
        <svg
            ...
            <g clip-path="url(#clip0_1641_14813)">
                ...
                <g mask="url(#mask0_1641_14813)">
                    <path
                        ...
                        fill="white"
                    />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0 0H21V8H0V0Z" fill="#D0091E" />
                    <path
...
export const AmericanFlag: React.FC<FLagsProps> = (props: FLagsProps) => {
    return (
        <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_1641_14819)">
...
export const ChinaFlag: React.FC<FLagsProps> = (props: FLagsProps) => {
    return (
        <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_1641_14832)">
...
export const KoreaFlag: React.FC<FLagsProps> = (props: FLagsProps) => {
    return (
        <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_1641_14838)">
