...
export const IndonesianFlag: React.FC<FLagsProps> = (props: FLagsProps) => {
    return (
        <svg
            width="21"
            height="15"
            ...
            <g clipPath="url(#clip0_1641_14813)">
                <mask id="mask0_1641_14813" maskUnits="userSpaceOnUse" x="0" y="0" width="21" height="15">
                    <path
                ...
                <g mask="url(#mask0_1641_14813)">
                    <path
                        d="M19 0H2C0.89543 0 0 0.89543 0 2V13C0 14.1046 0.89543 15 2 15H19C20.1046 15 21 14.1046 21 13V2C21 0.89543 20.1046 0 19 0Z"
                        fill="white"
                    />
                    <path fill-rule="evenodd" clipRule="evenodd" d="M0 0H21V8H0V0Z" fill="#D0091E" />
                    <path
...
export const AmericanFlag: React.FC<FLagsProps> = (props: FLagsProps) => {
    return (
        <svg
            width="21"
            height="15"
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_1641_14819)">
                <mask id="mask0_1641_14819" maskUnits="userSpaceOnUse" x="0" y="0" width="21" height="15">
                    <path
                        d="M19 0H2C0.89543 0 0 0.89543 0 2V13C0 14.1046 0.89543 15 2 15H19C20.1046 15 21 14.1046 21 13V2C21 0.89543 20.1046 0 19 0Z"
                        fill="white"
                    />
                </mask>
                <g mask="url(#mask0_1641_14819)">
                    <path
                        d="M19 0H2C0.89543 0 0 0.89543 0 2V13C0 14.1046 0.89543 15 2 15H19C20.1046 15 21 14.1046 21 13V2C21 0.89543 20.1046 0 19 0Z"
                        fill="white"
                    />
                    <path fill-rule="evenodd" clipRule="evenodd" d="M0 0H9V7H0V0Z" fill="#444379" />
                    <path
                        fill-rule="evenodd"
                        clipRule="evenodd"
...
export const ChinaFlag: React.FC<FLagsProps> = (props: FLagsProps) => {
    return (
        <svg
            width="21"
            height="15"
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_1641_14832)">
                <mask id="mask0_1641_14832" maskUnits="userSpaceOnUse" x="0" y="0" width="21" height="15">
                    <path
                        d="M19 0H2C0.89543 0 0 0.89543 0 2V13C0 14.1046 0.89543 15 2 15H19C20.1046 15 21 14.1046 21 13V2C21 0.89543 20.1046 0 19 0Z"
                        fill="white"
                    />
                </mask>
                <g mask="url(#mask0_1641_14832)">
                    <path
                        d="M19 0H2C0.89543 0 0 0.89543 0 2V13C0 14.1046 0.89543 15 2 15H19C20.1046 15 21 14.1046 21 13V2C21 0.89543 20.1046 0 19 0Z"
                        fill="#E02600"
                    />
...
export const KoreaFlag: React.FC<FLagsProps> = (props: FLagsProps) => {
    return (
        <svg
            width="21"
            height="15"
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_1641_14838)">
                <mask id="mask0_1641_14838" maskUnits="userSpaceOnUse" x="0" y="0" width="21" height="15">
                    <path
                        d="M19 0H2C0.89543 0 0 0.89543 0 2V13C0 14.1046 0.89543 15 2 15H19C20.1046 15 21 14.1046 21 13V2C21 0.89543 20.1046 0 19 0Z"
                        fill="white"
                    />
                </mask>
                <g mask="url(#mask0_1641_14838)">
                    <path
                        d="M19 0H2C0.89543 0 0 0.89543 0 2V13C0 14.1046 0.89543 15 2 15H19C20.1046 15 21 14.1046 21 13V2C21 0.89543 20.1046 0 19 0Z"
                        fill="white"
                    />
