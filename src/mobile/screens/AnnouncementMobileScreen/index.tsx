...
const AnnouncementMobileScreen:React.FC = ()  => {
    ...
    return (
        ...
        <div className="mobile-container home-screen dark-bg-main">
            ...
            {
                currentRecords && currentRecords.map((item, key) => (
                    <div className="beginner-item d-flex align-items-center justify-content-between mb-3" key={key}>
                        <div className="d-flex align-items-start justify-content-start">
                            ...
                            <div className="beginner-text ml-2">
                                ...
                                <h6 className="text-xxs grey-text font-normal">{moment(item.published_at).startOf('day').fromNow()}</h6>
                            </div>
                        </div>
                    </div>
                ))
