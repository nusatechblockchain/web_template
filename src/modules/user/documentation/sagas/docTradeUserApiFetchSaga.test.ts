...
describe('Documentation trade user api', () => {
    ...
    describe('Fetch trade user api', () => {
        const fakeResponse: DocTradeUserApiDataInterface = {
            info: {
                title: 'Exchange User API v2',
                description: 'API for Exchange application.',
                contact: {
                    name: 'nusatech.com',
                    email: 'hello@nusatech.com',
                    url: 'https://www.nusatech.com',
                },
                license: {
                    url: 'https://github.com/nusatechblockchain/exchange/blob/master/LICENSE.md',
                },
